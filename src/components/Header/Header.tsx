    ...
    return (
        <header className='mt-5'>
            ...
            <div className='flex justify-center flex-row gap-4 mt-2'>
                <img className='md:max-w-[48px] max-w-[36px] rounded-lg' src="../../icons/java-header.svg" alt="Java" />
                <img className='md:max-w-[48px] max-w-[36px]' src="../../icons/spring-boot.png" alt="Spring Boot" />
                <img className='md:max-w-[48px] max-w-[36px] rounded-lg' src="../../icons/ts.svg" alt="TypeScript" />
